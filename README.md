...
Follow these steps to get your Hashtopolis agent running on Vast.ai.

### Prerequisites

- A running Hashtopolis server.
- A voucher from your Hashtopolis server.
...
```bash
git clone https://github.com/bcherb2/vast-hashtopolis-runner.git
cd vast-hashtopolis-runner
```

### Step 2: Run the Setup Wizard

The interactive setup wizard is the easiest way to configure your deployment. It will guide you through the process of setting up your server connection and choosing an instance type.

```bash
./scripts/setup-wizard.sh
```

The wizard will ask for your Hashtopolis server URL and voucher ID. It will then generate a one-click deployment URL for Vast.ai.

### Step 3: Deploy on Vast.ai

Click the one-click deployment URL generated by the setup wizard to deploy your Hashtopolis agent on Vast.ai.
...
- **DockerHub**: `bcherb2/vast-hashtopolis-runner:latest` 
...
Choose a deployment template that best fits your needs. These templates can be used with the `deploy-template.sh` script for advanced configuration.
